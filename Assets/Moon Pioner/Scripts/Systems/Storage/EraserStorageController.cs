...
namespace Systems
{
    public class EraserStorageController : BuildingStorageController
    {
        public EraserStorageController(BuildingStorageView view) : base(view) { }
